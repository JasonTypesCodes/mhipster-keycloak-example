package an.example.service;

import an.example.config.Constants;
import an.example.domain.Authority;
import an.example.domain.User;
import an.example.repository.AuthorityRepository;
import an.example.repository.UserRepository;
import an.example.security.AuthoritiesConstants;
import an.example.security.SecurityUtils;
import an.example.service.dto.UserDTO;
import an.example.service.util.RandomUtil;
import an.example.web.rest.errors.*;
