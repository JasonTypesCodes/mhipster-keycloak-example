...
import an.example.config.DefaultProfileUtil;
...
@OpenAPIDefinition(
    info = @Info(
        title = "someapp",
        version = "0.0",
        description = "someapp API"
    )
)
public class SomeappApp {

    private static final Logger log = LoggerFactory.getLogger(SomeappApp.class);

    /**
     * Initializes SomeappApp.
     * <p>
