...
/**
 * Integration tests for the {@link an.example.web.rest.ClientForwardController} REST controller.
 */
@MicronautTest(application = SomeappApp.class)
