package an.example.config.timezone;

import an.example.SomeappApp;
import an.example.repository.timezone.DateTimeWrapper;
import an.example.repository.timezone.DateTimeWrapperRepository;
 ...
 */
@MicronautTest(application = SomeappApp.class, environments = {"test"})
